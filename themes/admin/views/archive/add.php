...
<div id="page_content">
    ...
    <!--用户操作-->
    	<div class=""><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("index",array());?>">返回到文档管理</a></span><span><a href="<?php echo $this->createUrl("add",array('channel_id'));?>">新增文档</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
    	<div class="edit_content">
           ...
           <div class="content_inline">
            ...
            <div class="content_inline">
           	 ...
           	 <div class="content_content"><?php echo EHtml::createCheckbox("archive_att",$archive_att,$archive_att_select,array('separator'=>'&nbsp;'));?></div>
           ...
           <div class="content_inline">
            ...
            <div class="content_inline">
           	 <div class="content_name">文章简短内容</div>
	       	...
	       	<div id="menu_content_2" class="menu_content" style="display:none">
	       		    <div class="content_inline">
           				...
           				<div class="content_inline">
           	 				<div class="content_name">上传附件</div>
           	 				<div class="content_content"><?php echo $form->createUploadfile($model,"upload_file",array());?></div>
           				  <div class="content_error"><?php echo $form->error($model,'upload_file');?></div>
           				</div>
