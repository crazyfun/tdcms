...
comments.prototype={
	...
	responsecomment:function(response_url){
		...
		jQuery.ajax({
			   type: "GET",
			   beforeSend: function(){
				   jQuery('#'+self.show_comments).html("<div class='loading_progress'><img  src='/css/images/progress.gif'></div>");
			   },
			   url: response_url,
			   processData:true,
   ...
   view_reply:function(comment_id){
      	...
      	if(child_comment.attr("show_flag")=='2'){
		     ...
		     jQuery.ajax({
			    type: "GET",
			    beforeSend: function(){
				   child_comment.html("<div class='loading_progress'><img  src='/css/images/progress.gif'></div>");
			    },
