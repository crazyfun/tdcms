<?php
class SpackageAction extends BaseAction{
	protected function beforeAction(){
        $this->controller->init_user_page();
        $this->controller->user_tag="spackage";
   ...
   protected function do_action(){
	...
	$status=$_REQUEST['status'];
		if(!empty($status)){
	 	 ...
	 	 $params[':service_type']='9';
	 	 $page_params['service_type']='9';
  	 ...
  	 //生成ActiveDataProvider对象
		...
		$this->display("spackage",array('model'=>$model,'dataProvider'=>$dataProvider,'page_params'=>$page_params,'cssPath'=>$cssPath,'jsPath'=>$jsPath));
  }
