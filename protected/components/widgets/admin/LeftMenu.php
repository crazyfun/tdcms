...
class LeftMenu extends CWidget
{
  ...
  public function get_top_menus($user_permissions){
	...
	static function get_default_access(){
		return array('ErrorError404','ErrorError403','ErrorError500','SiteIndex','SiteLogin','SiteLogout','SiteWelcome','MainMessage','MainDijieshe','MainLine','MainDelete','MainPermissiond','MainCrop','MainFilltree','MainChannelcategory','MainSearchuser');
