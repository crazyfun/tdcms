 ...
 <li>
                            <div class="tu">
                                 ...
                                 <div class="d_user_dl">
                                    <div class="search_left_box"><p><a href="<?php echo $this->createUrl("/restaurant/restaurant/detail",array('id'=>$data->id));?>"><?php if(!empty($data->restaurant_logo)){ $themb_image=Util::rename_thumb_file('150','110','',$data->restaurant_logo);echo CHtml::image($themb_image,$data->restaurant_name,array());}else{echo CHtml::image($cssPath."/images/logo_150_110.gif",$data->restaurant_name,array());}?></a></p><?php if($data->top=='2'){ ?> <div class="dingzhi">置顶</div> <?php } ?> </div>
                                </div>
                                <div class="d_user_tu">
