...
<head>
  ...
  <?php    
    ...
    Yii::app()->clientScript->registerCssFile($cssPath.'/css.css');
		Yii::app()->clientScript->registerCssFile($cssPath.'/registe.css');
		Yii::app()->clientScript->registerCoreScript('jquery');
		Yii::app()->clientScript->registerScriptFile('/js/basic.js');
		Yii::app()->clientScript->registerScriptFile('/js/validate.js');
  ?>
...
<body>
	<div class="main">
  	<?php $this->renderPartial("../../../../../themes/default/views/main/header",array(),false);?>
  	<div class="center">
  	   <?php echo $content; ?>
  	</div>
  	<?php $this->renderPartial("../../../../../themes/default/views/main/footer",array(),false);?>
  </div>
</body>
</html>
