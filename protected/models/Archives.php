  ...
  public $create_name="";
	...
	public function rules()
	{
		...
		return array(
			...
			array('upload_file,stitle, image,archive_tags,attr', 'length', 'max'=>100),
	...
	public function search()
	{
		...
		$criteria->compare('upload_file',$this->upload_file);
	 ...
	 switch($attribute_id){
      ...
      foreach($archive_att_select as $key => $value){
	    ...
	    case 'status':
	      ...
	      break;
	    case 'upload_file':
	      $upload_file=explode("/",$this->upload_file);
	      $upload_name=end($upload_file);
	      return CHtml::link($upload_name,$this->upload_name,array());
	      break;
	    case 'modify_time':
	...
	function get_operate(){
		  ...
		  $return_str.=CHtml::link('预览',"javascript:self.parent.parent.location.href='".Yii::app()->homeUrl."/mchannels/archive/archive/".$this->id."'",array('class'=>'operate_green','target'=>'_blank'));
		  if(Util::is_permission($user_permission_name,"status"))
