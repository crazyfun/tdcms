...
class Blocks extends BaseActive
{
	...
	public function rules()
	{
		...
		return array(
			array('name,identification', 'required','message'=>'{attribute}不能为空'),
			array('identification','exists_identification'),
			array('attr,name,sort_type,identification', 'length', 'max'=>30),
			...
			array('id, name, identification,view, tlen,dott,dlen, size,archive_ids, attr, channel, category, sort,sort_type,limit,cache,content', 'safe', 'on'=>'search'),
		);
	}
